...
**First of all... What is UniGetUI?** UniGetUI is an application whose main goal is to create an intuitive UI to manage the most common CLI package managers for Windows, such as [Winget](https://learn.microsoft.com/en-us/windows/package-manager/) and [Scoop](https://scoop.sh/). 
...
## Table of contents
 ...
 1. [UniGetUI](#unigetui)</b><br>
 2. [How does it work?](#how-does-it-work)</b><br>
 3. [Is UniGetUI safe?](#Is-UniGetUI-safe)</b><br>
 4. [Installation](#unigetui-installation)<br>
 5. [Common Problems](#common-problems)
 6. [Running and building the source code](https://marticliment.com/unigetui/help/build-overview/)
    - [Cloning the source code](https://marticliment.com/unigetui/help/build-overview/#download-source)
    - [Installing dependencies](https://marticliment.com/unigetui/help/build-overview/#download-dependencies)
    - [Running the source code](https://marticliment.com/unigetui/help/build-overview/#run-source)
    - [Building UniGetUI from source](https://marticliment.com/unigetui/help/build-overview/#build-source)
 7. [Translating UniGetUI](#translating-unigetui)
    - [How does it work (Nerd section)](#how-does-it-work-nerd-section)
    - [Contributing](#contributing)
    - [Rules](#rules)
    - [Supported languages](#supported-languages)
 8. [The icon and screenshots database](https://marticliment.com/unigetui/help/icons-and-screenshots/)
...
Therefore, UniGetUI provides a GUI for Winget-CLI and Scoop, making it easy for users to enjoy their capabilities without having to deal with a command-line interface (CLI).
<br><br><br>
...
<br><br>
_You have arrived at the end of the section. [Return to top](#unigetui)_
***
<br><br>
...
<br><p align="center"><b>Check out the <a href="https://marticliment.com/unigetui/help/install/#install">installation instructions</a> for more information!</b></p>
...
<br><p align="center"><b>Check out the <a href="https://github.com/marticliment/UniGetUI#faq">FAQ</a> for more information!</b></p>
...
See our new documentatiojn here: https://marticliment.com/unigetui/help/build-overview/
...
Since UniGetUI is an app that wants to reach every single person in the world running Windows 11, on issue [#67](https://github.com/marticliment/UniGetUI/issues/67) it was requested to add this feature. And here we are. On this page you will find useful information about how does the UniGetUI translation program works and how to participate on it, because anyone can contribute here!
...
3. I'll accept you (or not hehe) and you'll find the UniGetUI project in your [Tolgee Dashboard](https://tolgee.marticliment.com/projects/)
...
6. You can then start translating. The changes will be included with the next UniGetUI release.
...
[List of supported languages here](https://github.com/marticliment/UniGetUI#currently-supported-languages)
